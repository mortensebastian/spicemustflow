...
All six recipe pages (paella, fiskesuppe, pannekake, sjokoladekake, safraniskrem,
lussekatter) use this engine. `style-lussekatter.css` adds a Christmas green/gold
theme on top of `style-felles.css` for `lussekatter.html`.

## Script load order matters

Recipe pages load scripts in this order:
