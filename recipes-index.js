...
window.RECIPES_INDEX = [
...

  {
    ...
    image: "vafler.jpg", category: ["baking"], badge: "3 nivåer",
    recipeCategory: "Baking", cuisine: "Norsk",
...

  {
    ...
    image: "lasagne.jpg", category: ["middag"], badge: "3 nivåer",
    recipeCategory: "Hovedrett", cuisine: "Italiensk",
...

  {
    ...
    image: "boller.jpg", category: ["baking"], badge: "3 nivåer",
    recipeCategory: "Baking", cuisine: "Norsk",
...

  {
    ...
    image: "kanelboller.jpg", category: ["baking"], badge: "3 nivåer",
    recipeCategory: "Baking", cuisine: "Norsk",
  ...
  {
    id: "lapskaus", slug: "lapskaus.html", status: "live",
    shortName: "Lapskaus", name: "Lapskaus (brun og lys)",
    tagline: "Norsk tradisjonsgryte der poteten koker seg mør og tykner hele retten – brun eller lys, alt i én gryte.",
    description: "Tradisjonell lapskaus med mørt kjøtt og rotgrønnsaker i én gryte. Velg nivå (enkel/medium/kompleks), juster porsjoner og tilpass ingrediensene.",
    image: "lapskaus.jpg", category: ["middag"], badge: "3 nivåer",
    recipeCategory: "Hovedrett", cuisine: "Norsk",
    season: "nov",
    keywords: "lapskaus, brun lapskaus, lys lapskaus, lapskaus oppskrift, lapskaus med kjøttdeig",
    recipeYield: "4 porsjoner", times: { prep: "PT25M", cook: "PT1H30M", total: "PT1H55M" },
    search: "lapskaus brun lapskaus lys lapskaus tradisjonell norsk gryte høyrygg bog storfe lettsaltet svinekjøtt kålrot gulrot potet purre sellerirot oksekraft buljong rester pinnekjøtt pølselapskaus jukselapskaus kjøttdeig flatbrød tyttebær én gryte one pot høst vinter husmannskost",
    faq: [
      { q: "Hva er forskjellen på brun og lys lapskaus?", a: "Forskjellen ligger i hvordan kjøttet behandles. I brun lapskaus brunes kjøttet (og gjerne løken) godt i gryta først, ofte med et dryss mel, og den brune stekeskorpen farger og smaksetter hele retten. I lys lapskaus kokes kjøttet i stedet – tradisjonelt lettsaltet svinekjøtt – uten bruning og uten mel, så gryta forblir lys og mild. Historisk var brun lapskaus regnet som den «finere» varianten fordi den ble laget på bedre storfebiter, mens lys lapskaus kunne lages på rimeligere kjøtt, saltet flesk eller helt uten kjøtt. Grønnsakene og teknikken ellers er den samme. I oppskriften vår er alle tre nivåene brune; vil du ha lys lapskaus, bytter du kjøttet til lettsaltet svinekjøtt, hopper over bruningen og fjerner melet – da justeres mengdene og saltet automatisk." },
      { q: "Hvilket kjøtt bruker man i lapskaus?", a: "Klassisk brun lapskaus lages på høyrygg eller bog av storfe – seige, smaksrike biter med mye bindevev som blir møre og saftige av lang, rolig koking. Til lys lapskaus er lettsaltet svinekjøtt det tradisjonelle valget. Lam fungerer også godt og gir en rundere smak. Skal det gå fort på en hverdag, kan du bruke kjøttdeig eller middagspølser, og har du rester av kokt kjøtt – pinnekjøtt, stek eller juleribbe – er det egentlig den mest tradisjonelle lapskausen av alle. Unngå helt magre biter som indrefilet; de blir tørre av koketiden." },
      { q: "Hvor lenge må lapskaus koke?", a: "Det avhenger av kjøttet. Storfe i terninger (høyrygg, bog) trenger cirka 1 til 1,5 time med rolig småkoking før det er mørt – gryta skal så vidt boble, ikke fosskoke, ellers blir kjøttet tørt og trevlete. Svinekjøtt går raskere, cirka 40–50 minutter. Først når kjøttet er mørt legger du i rotgrønnsakene, som trenger 20–25 minutter til. Bruker du kjøttdeig, pølse eller ferdig kokt kjøtt, er hele retten klar på 25–30 minutter, siden det bare er potetene og grønnsakene som skal bli møre." },
      { q: "Hvordan blir lapskausen passe tykk?", a: "Det er selve poenget med lapskaus: den tykner av seg selv fordi poteten koker i gryta. Bruk melne poteter, som Beate eller Kerrs Pink, og rør godt mot slutten – noen av potetbitene mases ut og gir stivelsen som binder kraften. Det er nettopp dette som skiller lapskaus fra en kjøttsuppe, som forblir tynn. Vil du ha den tykkere, koker du den noen minutter til uten lokk, eller moser flere potetbiter mot grytekanten. Vil du ha den tynnere, sper du med litt kraft eller vann. Bruker du faste poteter, som holder formen, må du regne med å tykne litt med mel, maizena eller potetmel i stedet." },
      { q: "Kan man fryse lapskaus?", a: "Ja, lapskaus fryser overraskende godt og er perfekt å lage stor porsjon av. Avkjøl den raskt, frys den i porsjonsbokser eller -poser, og bruk den innen cirka 3 måneder. Potetene kan bli litt mykere i konsistensen etter frysing, men siden retten allerede er mosete er det knapt merkbart. Tin i kjøleskapet over natten og varm den forsiktig opp igjen under omrøring, gjerne med en skvett vann eller kraft hvis den har tyknet for mye. Lapskaus smaker som kjent enda bedre dagen etter." },
      { q: "Hvor lenge holder lapskaus seg i kjøleskapet?", a: "Avkjøl gryta raskt og sett den kaldt, så holder lapskausen seg 3–4 dager i kjøleskapet i en tett boks. Kok den godt opp igjen før servering, ikke bare lunk den. La aldri gryta stå og avkjøles på kjøkkenbenken i flere timer – kokt kjøtt og poteter er nettopp den typen mat bakterier trives i. Skal du ta vare på den lenger, er frysing det tryggeste." },
      { q: "Hva serveres til lapskaus?", a: "Det klassiske tilbehøret er flatbrød og smør, og rørte tyttebær eller tyttebærsyltetøy ved siden av. Syren og sødmen i tyttebærene skjærer gjennom det fete kjøttet og løfter hele gryta – derfor er den lille skjeen ved siden av mer enn pynt. Rognebærgelé eller ripsgelé gjør samme nytten. Ellers trenger lapskaus ingenting: poteter, grønnsaker og kjøtt ligger allerede i samme gryte." },
      { q: "Kan jeg lage lapskaus av rester?", a: "Ja – det er faktisk lapskausens opprinnelige idé. Retten oppsto som en måte å bruke opp kokt kjøtt, kraft og rotgrønnsaker på, og den er fortsatt en av de beste måtene å redde julerester på. Rester av pinnekjøtt, ribbe, juleskinke, vossakorv eller kalkun plukkes i biter og røres inn helt mot slutten – kjøttet er ferdig kokt og trenger bare å bli varmt. Har du kraften fra pinnekjøttet eller steken, bruker du den som væske; da får du en dyp, ferdig smaksatt gryte nesten gratis. Husk å smake til saltet til slutt, for saltet kjøtt salter også gryta." },
      { q: "Kan man lage lapskaus med kjøttdeig?", a: "Ja. Lapskaus med kjøttdeig kalles gjerne jukselapskaus, og er hverdagsversjonen som er ferdig på under en halvtime. Du bruner kjøttdeigen først, har i løk, poteter og gulrot, sper med buljong og koker til potetene er møre og begynner å falle fra hverandre. Smaken blir litt mildere enn med kjøtt i terninger, men konsistensen og prinsippet er det samme – og det er nettopp denne varianten som er enkel-nivået i oppskriften vår. Middagspølser i skiver fungerer like godt og er ofte barnas favoritt." },
      { q: "Hvorfor heter det lapskaus?", a: "Navnet kommer etter alt å dømme fra sjømannsspråket. I en engelsk ordbok fra 1795 er ordet «lobscouse» eller «lob's course» oppført om en klumpete matrett, og retten var billig, mettende skipskost som spredte seg langs kysten. På dansk heter den skipperlabskovs, og i havnebyen Liverpool ble den så vanlig at innbyggerne fortsatt kalles «scousers». I norsk dagligtale har ordet dessuten fått en overført betydning: en lapskaus er også noe som er rotete blandet sammen." }
    ]
  },

  {
    ...
    image: "chili-con-carne.jpg", category: ["middag"], badge: "3 nivåer",
    recipeCategory: "Hovedrett", cuisine: "Tex-mex",
