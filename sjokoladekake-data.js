...
const swapOptions = {
  ...
  cocoa: [
    { id: "dark_chocolate", label: "Smeltet mørk sjokolade", amount: 150, unit: "g", taste: { bitter: 2 }, note: "Smelt og rør inn; rikere og mer intens. Reduser gjerne melmengden litt." }
  ]
};
...
const sjokoladekakeRecipes = {
  ...
  enkel: {
    ...
    ingredients: [
      ...
      { id: "egg",           label: "Egg",          amount: 2, unit: "stk", role: "binder",   scaling: "linear",    addStage: "early", removable: false },
      { id: "milk",          label: "Melk",         amount: 2, unit: "dl",  role: "liquid",   scaling: "linear",    addStage: "early", removable: false },
  ...
  medium: {
    ...
    ingredients: [
      ...
      { id: "butter",        label: "Smeltet smør", amount: 150, unit: "g", role: "fat",      scaling: "linear",    addStage: "early", removable: false },
      { id: "milk",          label: "Melk",         amount: 2, unit: "dl",  role: "liquid",   scaling: "linear",    addStage: "early", removable: false, note: "Bytt gjerne til sterk kaffe for dypere smak." },
      { id: "vanilla",       label: "Vaniljesukker", amount: 1, unit: "ts", role: "aromatic", scaling: "nonlinear", addStage: "early", removable: true },
  ...
  kompleks: {
    ...
    ingredients: [
      { id: "flour",         label: "Hvetemel",            amount: 2.5, unit: "dl", role: "bulk",     scaling: "linear",    addStage: "early", removable: false },
      { id: "sugar",         label: "Sukker",              amount: 3, unit: "dl",   role: "sweet",    scaling: "linear",    addStage: "early", removable: false, taste: { sweet: 3 } },
